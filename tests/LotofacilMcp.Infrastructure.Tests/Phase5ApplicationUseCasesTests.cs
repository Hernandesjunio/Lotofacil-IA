...
public sealed class Phase5ApplicationUseCasesTests
{
    ...
    [Fact]
    public void ComputeWindowMetricsUseCase_ReturnsQuantidadeVizinhosPorConcursoPerCatalog()
    {
        var sut = BuildComputeWindowMetricsUseCase();
        var input = new ComputeWindowMetricsInput(
            WindowSize: 3,
            EndContestId: 3,
            Metrics: [new MetricRequestInput("quantidade_vizinhos_por_concurso")],
            FixturePath: GetFixturePath());
    ...
    [Fact]
    public void ComputeWindowMetricsUseCase_ReturnsSequenciaMaximaVizinhosPorConcursoPerCatalog()
    {
        var sut = BuildComputeWindowMetricsUseCase();
        var input = new ComputeWindowMetricsInput(
            WindowSize: 3,
            EndContestId: 3,
            Metrics: [new MetricRequestInput("sequencia_maxima_vizinhos_por_concurso")],
            FixturePath: GetFixturePath());
    ...
    [Fact]
    public void ComputeWindowMetricsUseCase_ReturnsDistribuicaoLinhaPorConcursoPerCatalog()
    {
        var sut = BuildComputeWindowMetricsUseCase();
        var input = new ComputeWindowMetricsInput(
            WindowSize: 3,
            EndContestId: 3,
            Metrics: [new MetricRequestInput("distribuicao_linha_por_concurso")],
            FixturePath: GetFixturePath());
    ...
    public void ComputeWindowMetricsUseCase_ReturnsTop10MenosSorteadosPerCatalog()
    {
        ...
        var input = new ComputeWindowMetricsInput(
            WindowSize: 3,
            EndContestId: 3,
            Metrics: [new MetricRequestInput("top10_menos_sorteados")],
            FixturePath: GetFixturePath());
