...
public sealed class Top10MaioresTotaisDePresencasNaJanelaMetricTests
{
    [Fact]
    public void Window_OnSyntheticFixture_FirstThreeContests_MatchesTop10MaisSorteados_WhenTotalsEqualFrequencies()
    {
        // Normative references:
        // - docs/metric-catalog.md (Tabela 2): ordenar total_de_presencas_na_janela_por_dezena desc; empate por dezena asc; top 10.
        ...
        var metric = sut.Dispatch("top10_maiores_totais_de_presencas_na_janela", window);

        Assert.Equal("top10_maiores_totais_de_presencas_na_janela", metric.MetricName);
    ...
    public void Window_Size1_TieBreakUsesAscendingDezena_WhenTotalsMatch()
    {
        ...
        // All present dezenas tie at 1; tie-break is dezena asc.
