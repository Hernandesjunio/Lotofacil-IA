...
| `total_de_presencas_na_janela_por_dezena` | Total de vezes que cada dezena 1 a 25 **saiu** nos concursos **desta janela** (**equivalente** a `frequencia_por_dezena` no mesmo recorte; nome autoexplicativo). Soma global dos 25 = `15×N`. |
