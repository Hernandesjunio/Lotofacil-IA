...
| `total_de_presencas_na_janela_por_dezena` | Total de vezes em que cada dezena (1 a 25) **saiu** nos concursos **desta janela** (contagem total no recorte). **Dica de leitura:** “total na janela” (não é sequência; não reinicia). |
